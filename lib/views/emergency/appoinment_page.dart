...
class _AppointmentPageState extends State<AppointmentPage> {
  ...
  void handleGridOptionClick(Doctor selectedDoctor) {
    setState(() {
      ...
      filterDoctorNames =
          extractNames(filterDoctorsBySpecialty(selectedSpecialty));
    });
  }
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color.fromARGB(255, 8, 100,
                                176), // Make the button background transparent
                      ...
                      child: Container(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              color: isSelected
                                  ? Color.fromARGB(255, 207, 208, 208)
                                  : Colors.white,
                              child: ListTile(
  ...
  List<Doctor> doctorSpeciality = [
    ...
    Doctor(
        name: "Pulmonologist",
        icon: const Icon(FontAwesomeIcons.lungs, color: Colors.pink),
        selected: false),
    Doctor(
        name: "Oncologist",
    ...
    Doctor(
        ...
        icon: const Icon(FontAwesomeIcons.stethoscope, color: Colors.black),
        selected: false),
    Doctor(
        name: "Radiologist",
        icon: const Icon(FontAwesomeIcons.xRay),
        selected: false),
    Doctor(
        name: "Pediatrician",
